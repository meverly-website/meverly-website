...
const DESKTOP_PATH =
  ...
  "C 81.2,125.2 81.8,133.3 81,142 C 80.2,150.7 77.3,158.3 75,167 " +
  "C 72.7,175.7 68.5,182.8 67,194 C 65.5,205.2 66.3,221.3 66,234 " +
  "C 65.7,246.7 65,253.2 65,270 C 65,286.8 67.2,319.7 66,335 " +
  "C 64.8,350.3 60.5,355.2 58,362 C 55.5,368.8 52.5,365.8 51,376 " +
