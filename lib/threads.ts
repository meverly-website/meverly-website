...
export const HOME_THREAD = {
  ...
  citation: {
    mobile: {
      points: [
        [60, 0], [60, 1.5], [67, 3.2], [76.6, 4.5], [82.9, 11.1],
        [69.6, 16.6], [64, 10], [71, 4.5], [82.2, 13.3], [93.4, 21.6],
        [98.2, 32], [98.2, 45], [98.2, 70], [98.2, 98.44], [98.2, 100],
      ],
      bands: "transparent 0%, transparent 1%, #000 5.5%, #000 100%",
    },
    tablet: {
      points: [
        [60, 0], [60, 1.5], [66, 3.2], [74, 4.5], [78.5, 13.2],
        [69, 20.5], [65, 11.8], [70, 4.5], [78, 16.1], [86, 27],
        [94, 35], [99, 45], [99, 55], [99, 75], [99, 98.44], [99, 100],
      ],
      bands: "transparent 0%, transparent 1%, #000 5.5%, #000 100%",
    },
    desktop: {
...
export const BOOK_THREAD = {
  ...
  citation: {
    mobile: {
      points: [
        [98.2, 0], [98.2, 1.69], [98.2, 30], [98.2, 45], [98.2, 58],
        [96.5, 74], [91, 86], [83, 92], [73, 96], [66, 98.5],
      ],
