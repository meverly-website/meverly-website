  ...
  return (
    <main className="min-h-screen bg-[#0E0B0B] px-6 py-24 text-[#F5F1EB]">
      <div className="mx-auto max-w-4xl">
        ...
        <Link
          href="/"
          className="mb-16 inline-flex items-center gap-2 text-sm uppercase tracking-[0.25em] text-[#C99A63] transition hover:text-white"
        >
          ← Retour à l'accueil
        </Link>
        ...
        <section className="mb-16">
          ...
          <div className="space-y-6 text-lg leading-8 text-[#E6DED5]">
            ...
            <p>
              Les données sont destinées à MEVERLY et à ses prestataires
              techniques, notamment les prestataires nécessaires à
              l’hébergement du site et à l’envoi des e-mails, dans la
              mesure nécessaire au fonctionnement du formulaire.
            </p>
        ...
        <section className="mb-16">
          ...
          <p className="text-lg leading-8 text-[#E6DED5]">
          ...
          <p className="mt-5">
            <a
              href="mailto:m.everlybooks@gmail.com"
              className="text-lg text-[#C99A63] transition hover:text-white"
            >
              m.everlybooks@gmail.com
            </a>
          </p>
